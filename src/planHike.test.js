...
describe("PlanHike Component", () => {
  ...
  beforeEach(() => {
    ...
    // Mock axios.get and axios.post directly
  ...
  test("opens invite modal and toggles friends", async () => {
    // Mock sequential axios.get calls: first for trails, second for friends
    mockGet
  ...
  test("filters by name, location, difficulty, duration, description", async () => {
    ...
    fireEvent.change(screen.getByLabelText(/Duration of trails ≤ set time/i), {
